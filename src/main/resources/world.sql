...
-- 正在导出表  world.city 的数据：~4,190 rows (大约)
/*!40000 ALTER TABLE `city` DISABLE KEYS */;
INSERT INTO `city` (`ID`, `Name`, `CountryCode`, `District`, `Population`) VALUES
	(1, 'testInsert', 'CHN', 'test', 1122),
	...
	(4080, 'testInsert_auto_id', 'CHN', 'test', 1122);
/*!40000 ALTER TABLE `city` ENABLE KEYS */;

-- 导出  表 world.country 结构
...
-- 正在导出表  world.country 的数据：~239 rows (大约)
...
-- 正在导出表  world.countrylanguage 的数据：~984 rows (大约)
